...
## 필수 공개 스킬
- `using-agent-skills` — `addyosmani/agent-skills:skills/using-agent-skills` · MIT · 설치 대상 `./skills/using-agent-skills/SKILL.md`
...
- `executing-plans` — `obra/superpowers:skills/executing-plans` · MIT · 설치 대상 `./skills/executing-plans/SKILL.md`
